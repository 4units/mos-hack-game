...
import { completeLineGameLevel, type CompleteLineLevelResponse } from '../services/linkNumberApi.ts';
import { useStarsStore } from '../stores/starsStore.ts';
import { STARS_BALANCE_QUERY_KEY } from './useStarsBalance.ts';
import { LINK_NUMBER_LEVEL_QUERY_KEY } from './useLinkNumberLevel.ts';
